Тесты в отношении достаточно сложных проектов - это способ экономить на средней дистанции, гарантируя качество продукта. Ручное тестирование с ростом проекта становится более сложным, а автоматическое нет. Если тесты пишутся строго на основании требований, являются честными (например, когда тест зеленый и модуль работает некорректно - пишется новый тест, а сами модули - изолируются при тестировании от других) и нехрупкими (не падают при рефакторинге), то они позволяют эффективно работать и снижают bus factor команды. Тестирование бывает:
