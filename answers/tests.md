Тесты в отношении достаточно сложных проектов - это способ экономить на средней дистанции, гарантируя качество продукта. Ручное тестирование с ростом проекта становится более сложным, а автоматическое нет. Если тесты пишутся строго на основании требований и являются честными (например, когда тест зеленый и модуль работает некорректно, то пишется новый тест), то они позволяют эффективно работать и снижают bus factor команды. Тестирование бывает:
