* Если идет обращение к переменной до ее обьявленная (через var), то она будет равна undefined, потому что всплывает. Но всплытие будет только в случае, если var не заключен в другую функцию (на уровень видимости выше).
